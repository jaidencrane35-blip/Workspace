...
CREATE TABLE IF NOT EXISTS workspace_semantic_query_snapshots (
...
CREATE INDEX IF NOT EXISTS idx_workspace_semantic_query_snapshots_workspace
    ON workspace_semantic_query_snapshots (workspace_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_workspace_semantic_query_snapshots_status
    ON workspace_semantic_query_snapshots (workspace_id, status);

CREATE TABLE IF NOT EXISTS workspace_semantic_query_history (
    id TEXT PRIMARY KEY NOT NULL,
    workspace_id TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_workspace_semantic_query_history_workspace
    ON workspace_semantic_query_history (workspace_id, recorded_at DESC);
