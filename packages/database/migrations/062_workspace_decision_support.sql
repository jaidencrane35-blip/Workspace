...
CREATE TABLE IF NOT EXISTS workspace_decision_support_snapshots (
    ...
    tradeoff_count INTEGER NOT NULL DEFAULT 0,
    ...
    evidence_bundles_json TEXT NOT NULL DEFAULT '[]',
...
CREATE INDEX IF NOT EXISTS idx_workspace_decision_support_snapshots_workspace
    ON workspace_decision_support_snapshots (workspace_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_workspace_decision_support_snapshots_status
    ON workspace_decision_support_snapshots (workspace_id, status);

CREATE TABLE IF NOT EXISTS workspace_decision_support_history (
    id TEXT PRIMARY KEY NOT NULL,
    workspace_id TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_workspace_decision_support_history_workspace
    ON workspace_decision_support_history (workspace_id, recorded_at DESC);
