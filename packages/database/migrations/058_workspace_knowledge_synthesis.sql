...
-- Derived artefacts only — never Memory SoT, Cognitive Model, decisions, or mutations.

CREATE TABLE IF NOT EXISTS workspace_knowledge_synthesis_snapshots (
...
CREATE INDEX IF NOT EXISTS idx_workspace_knowledge_synthesis_snapshots_workspace
    ON workspace_knowledge_synthesis_snapshots (workspace_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_workspace_knowledge_synthesis_snapshots_status
    ON workspace_knowledge_synthesis_snapshots (workspace_id, status);

CREATE TABLE IF NOT EXISTS workspace_knowledge_synthesis_history (
    id TEXT PRIMARY KEY NOT NULL,
    workspace_id TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_workspace_knowledge_synthesis_history_workspace
    ON workspace_knowledge_synthesis_history (workspace_id, recorded_at DESC);
