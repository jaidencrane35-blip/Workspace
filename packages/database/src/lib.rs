...
pub use repositories::{
    ...
    DecisionEngineRepository, DecisionQueueRepository, DesktopArrangementRepository,
    ...
    WorkspaceAssistantExplanationRepository, WorkspaceAssistantInteractionRepository,
    WorkspaceAssistantPersonalisationRepository, WorkspaceAssistantRetrievalRepository,
