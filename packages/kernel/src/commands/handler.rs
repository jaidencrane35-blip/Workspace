...
use crate::commands::workspace_assistant_explanation::{
...
impl CommandHandler {
    ...
    pub fn generate_workspace_knowledge_synthesis(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_mutation(GenerateWorkspaceKnowledgeSynthesis::new(workspace_id))
    }

    pub fn get_workspace_knowledge_synthesis(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(GetWorkspaceKnowledgeSynthesis::new(workspace_id))
    }

    pub fn get_workspace_knowledge_summary(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
    ...
    pub fn explain_knowledge_synthesis(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(ExplainKnowledgeSynthesis::new(workspace_id))
    }
    ...
    pub fn generate_workspace_decision_support(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_mutation(GenerateWorkspaceDecisionSupport::new(workspace_id))
    }

    pub fn get_workspace_decision_support(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(GetWorkspaceDecisionSupport::new(workspace_id))
    }

    pub fn get_workspace_decision_support_summary(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        history_limit: usize,
    ) -> Result<WorkspaceDecisionSupportSummary> {
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_query(
            GetWorkspaceDecisionSupportSummary::new(workspace_id, history_limit),
        )
    }

    pub fn explain_workspace_decision_support(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(ExplainWorkspaceDecisionSupport::new(workspace_id))
    }
    ...
    pub fn generate_workspace_evidence_freshness(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_mutation(GenerateWorkspaceEvidenceFreshness::new(workspace_id))
    }

    pub fn get_workspace_evidence_freshness(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(GetWorkspaceEvidenceFreshness::new(workspace_id))
    }

    pub fn get_workspace_evidence_freshness_summary(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        history_limit: usize,
    ) -> Result<WorkspaceEvidenceFreshnessSummary> {
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_query(
            GetWorkspaceEvidenceFreshnessSummary::new(workspace_id, history_limit),
        )
    }

    pub fn explain_evidence_freshness(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(ExplainEvidenceFreshness::new(workspace_id))
    }
    ...
    pub fn package_workspace_assistant_retrieval(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_mutation(
            PackageWorkspaceAssistantRetrieval::new(workspace_id, human_ask),
        )
    }
    ...
    pub fn get_workspace_assistant_retrieval(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(GetWorkspaceAssistantRetrieval::new(workspace_id))
    }

    pub fn get_workspace_assistant_retrieval_summary(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        history_limit: usize,
    ) -> Result<WorkspaceAssistantRetrievalSummary> {
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_query(
            GetWorkspaceAssistantRetrievalSummary::new(workspace_id, history_limit),
        )
    }
    ...
    pub fn explain_assistant_retrieval(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(ExplainAssistantRetrieval::new(workspace_id))
    }

    pub fn assistant_retrieval_attempt_execute() -> Result<()> {
        crate::services::WorkspaceAssistantRetrievalService::attempt_execute()
    }
    ...
    pub fn package_workspace_assistant_explanation(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_mutation(
            PackageWorkspaceAssistantExplanation::new(workspace_id, human_ask),
        )
    }
    ...
    pub fn get_workspace_assistant_explanation(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(GetWorkspaceAssistantExplanation::new(workspace_id))
    }

    pub fn get_workspace_assistant_explanation_summary(
        kernel: &WorkspaceKernel,
        actor: ActorContext,
        intent: IntentContext,
        workspace_id: String,
        history_limit: usize,
    ) -> Result<WorkspaceAssistantExplanationSummary> {
        CommandPipeline::new(kernel.command_context(actor, intent)).execute_query(
            GetWorkspaceAssistantExplanationSummary::new(workspace_id, history_limit),
        )
    }
    ...
    pub fn explain_assistant_explanation(
        ...
        CommandPipeline::new(kernel.command_context(actor, intent))
            .execute_query(ExplainAssistantExplanation::new(workspace_id))
    }
