...
fn build_definitions() -> Vec<ActionIntentDefinition> {
    vec![
        ...
        definition(
            "capture-desktop-arrangement",
            "Capture Desktop Arrangement",
            "Save currently observed windows into a named desktop arrangement.",
            ActionIntentCategory::System,
        ...
        definition(
            ...
            "Restore Desktop Arrangement",
            "Restore a saved desktop arrangement through the Permission Gateway and WindowController.",
            ActionIntentCategory::System,
        ...
        definition(
            "get-desktop-arrangement",
            "Get Desktop Arrangement",
            "Load a saved desktop arrangement by identifier.",
            ActionIntentCategory::System,
