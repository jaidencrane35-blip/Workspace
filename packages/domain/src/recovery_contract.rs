...
use crate::workspace_assistant_personalisation::{
    AssistantPersonalisationHistoryEntry, WorkspaceAssistantPersonalisationProjection,
};
...
/// Recovery must not invent completeness, fill gaps, repair missing artefacts, or estimate completeness.
pub fn recovery_must_not_fabricate_evidence_completeness(
...
/// Fabricated actionable evidence-completeness history must fail the recovery contract.
pub fn recovery_must_not_fabricate_actionable_evidence_completeness_history(
...
pub fn recovery_must_not_fabricate_assistant_retrieval(
...
pub fn recovery_must_not_fabricate_assistant_personalisation(
...
/// Fabricated actionable assistant-personalisation history must fail the recovery contract.
pub fn recovery_must_not_fabricate_actionable_assistant_personalisation_history(
