...
pub const PLATFORM_CONCEPT_OWNERS: &[ConceptOwnership] = &[
    ...
    ConceptOwnership {
        concept: "evidence_reliability",
        owner: "WorkspaceEvidenceReliabilityService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "evidence_reliability_snapshot",
        owner: "WorkspaceEvidenceReliabilityService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_surface",
        owner: "WorkspaceAssistantSurfaceService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_surface_snapshot",
        owner: "WorkspaceAssistantSurfaceService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_context",
        owner: "WorkspaceAssistantContextService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_context_snapshot",
        owner: "WorkspaceAssistantContextService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_retrieval",
        owner: "WorkspaceAssistantRetrievalService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_retrieval_snapshot",
        owner: "WorkspaceAssistantRetrievalService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_explanation",
        owner: "WorkspaceAssistantExplanationService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_explanation_snapshot",
        owner: "WorkspaceAssistantExplanationService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_interaction",
        owner: "WorkspaceAssistantInteractionService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_interaction_snapshot",
        owner: "WorkspaceAssistantInteractionService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_personalisation",
        owner: "WorkspaceAssistantPersonalisationService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
        concept: "assistant_personalisation_snapshot",
        owner: "WorkspaceAssistantPersonalisationService",
        kind: ConceptOwnerKind::DurableStore,
    },
    ConceptOwnership {
