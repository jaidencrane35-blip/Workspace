...
pub use action_proposal::{
    ...
    GovernanceDissentRecord, GovernanceExpiryRules, GovernanceImpactClass, GovernancePolicy,
    GovernanceRecord, GovernanceReviewDecision, GovernanceReviewDecisionKind,
    GovernanceReviewRouting, GovernanceReviewerRequirements, GovernanceRisk,
    GovernanceTimestamps, OutcomeAdaptationProposal, OutcomeAdaptationReviewStatus,
    PublicationReadiness, PublicationReadinessState, PublishRequest, PublishRequestStatus,
    PublishedVersionRecord, RecommendationFamily, RecommendationGovernanceRecord,
