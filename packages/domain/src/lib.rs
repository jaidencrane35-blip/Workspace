...
pub use workspace_evidence_navigation::{
    EvidenceNavigationCompleteness, EvidenceNavigationError, EvidenceNavigationEvidenceRef,
    EvidenceNavigationHistoryEntry, EvidenceNavigationSession, EvidenceNavigationStatus,
    EvidencePath, EvidenceNavigationDiagSummary, NavigationGap, NavigationLineage, TraversalScope,
...
pub use workspace_evidence_coverage::{
    ...
    CoverageScope, EvidenceCoverageCompleteness, EvidenceCoverageError, EvidenceCoverageEvidenceRef,
    EvidenceCoverageHistoryEntry, EvidenceCoverageStatus, WorkspaceEvidenceCoverageExplanation,
...
pub use workspace_evidence_freshness::{
    ...
    EvidenceFreshnessHistoryEntry, EvidenceFreshnessStatus, FreshnessAssessment, FreshnessDiagnostics,
    FreshnessGap, FreshnessLineage, FreshnessObservation, FreshnessObservationState, FreshnessScope,
    WorkspaceEvidenceFreshnessExplanation, WorkspaceEvidenceFreshnessProjection,
    WorkspaceEvidenceFreshnessSnapshot, WorkspaceEvidenceFreshnessSummary,
};
