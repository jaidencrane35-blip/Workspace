...
pub use action_proposal::{
    ...
    GovernanceDecisionHistoryEntry, GovernanceDependencyKind, GovernanceDependencyRequirement,
    GovernanceDissentRecord, GovernanceEvidenceView, GovernanceExpiryRules,
    GovernanceFailureCategory, GovernanceFailureRecoveryRequirement, GovernanceFailureRecoveryState,
    GovernanceFailureState, GovernanceHistoricalSnapshot, GovernanceImpactClass,
    GovernanceIntegrityCheckKind, GovernanceIntegrityDiagnostic,
    GovernanceIntegrityDiagnosticSeverity, GovernanceIntegrityVerification,
    GovernanceLifecycleStage, GovernanceObligation, GovernanceObligationKind,
    GovernanceObligationStatus, GovernancePolicy, GovernanceProposalView, GovernanceRecord,
    GovernanceReviewDecision, GovernanceReviewDecisionKind, GovernanceReviewRouting,
    GovernanceReviewerRequirements, GovernanceReviewerView, GovernanceRisk, GovernanceRiskView,
    GovernanceTimeline, GovernanceTimelineEvent, GovernanceTimestamps, GovernanceWorkspace,
