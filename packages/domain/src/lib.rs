...
pub mod workspace_assistant_personalisation;
...
pub mod workspace_evidence_reliability;
...
pub use action_proposal::{
    governance_authority_is_none, ActionProposal, ActionProposalError, ActionProposalRisk,
    AdaptationReviewAuditEvent, AdaptationReviewerIdentity, AdaptationRiskClass, BehaviourVersion,
    BehaviourVersionLifecycle, ChangeEvaluation, ChangeRollbackMetadata,
    ControlledChangeAuditMetadata, ControlledChangeSurface, GovernanceActorRefs,
    ...
    GovernanceComplianceContract, GovernanceComplianceDiagnostic, GovernanceComplianceSeverity,
    GovernanceConditionContract, GovernanceConflictEntry, GovernanceConflictKind,
    GovernanceConflictResolutionContract, GovernanceConflictState, GovernanceConsensusRule,
    GovernanceDashboardComplianceStatus, GovernanceDecisionEvidence,
    GovernanceDecisionHistoryEntry, GovernanceDecisionPackage, GovernanceDelegationAuditEvent,
    GovernanceDelegationContract, GovernanceDelegationRecord, GovernanceDelegationStatus,
    GovernanceDependencyKind, GovernanceDependencyRequirement, GovernanceDissentRecord,
    GovernanceEvidenceView, GovernanceExpiryRules, GovernanceExportPackage,
    ...
    GovernanceNotificationTrigger, GovernanceObligation, GovernanceObligationKind,
    ...
    GovernanceTimestamps, GovernanceWorkspace, OutcomeAdaptationProposal,
    OutcomeAdaptationReviewStatus, PublicationCompatibilityCheck, PublicationEnvironment,
    PublicationFailureHandling, PublicationMigrationRequirement, PublicationReadiness,
    PublicationReadinessState, PublicationRollbackRequirement, PublicationRolloutStage,
    PublicationSafetyContract, PublicationSafetyLifecycleState, PublicationValidationGate,
    PublishRequest, PublishRequestStatus, PublishedVersionRecord, RecommendationFamily,
    ...
    RecommendationResultKind, RecommendationReviewActionResult, RecommendationUserDecision,
...
pub use ai_memory::{
    AiMemoryAwareness, AiMemoryError, MemoryEntry, MemoryLifecycleState, MemoryMetadata, MemoryType,
};
pub use ai_model::{
...
pub use desktop_behaviour::{
    ...
    DesktopObservedFocusSpan, DesktopWindowRevisit, DESKTOP_BEHAVIOUR_GAP_SECONDS,
...
pub use execution_reconciliation::{
    ...
    ExecutionLifecycleActionableEntry, ExecutionLifecycleHistoryEntry,
    ExecutionLifecycleProjection, ExecutionLifecycleRecord, ExecutionReconciliation,
...
pub use ids::{
    ...
    AiPlanStepId, ApplicationId, AttentionItemId, AuditEventId, AutomationContractId,
...
pub use intent_execution::{IntentExecutionError, IntentExecutionRequest, IntentExecutionStatus};
pub use observation::{
...
pub use policy_governance::{
    ...
    GovernanceEvaluationStatus, GovernanceExplanation, GovernanceRecommendation, PolicyDefinition,
    PolicyDefinitionStatus, PolicyEvaluation, PolicyEvaluationResult, PolicyGovernanceError,
    PolicyGovernanceHistoryEntry, PolicyGovernanceMeta, PolicyGovernanceSnapshot,
    PolicyGovernanceSummary, PolicyGovernanceView, PolicyScope, PolicySeverity,
};
...
pub use workspace_assistant_explanation::{
    AssistantExplanationCitation, AssistantExplanationDiagnostics, AssistantExplanationError,
    AssistantExplanationGap, AssistantExplanationHistoryEntry, AssistantExplanationLineage,
...
pub use workspace_assistant_personalisation::{
    AssistantPersonalisationAdaptation, AssistantPersonalisationDiagnostics,
    AssistantPersonalisationError, AssistantPersonalisationGap,
    AssistantPersonalisationHistoryEntry, AssistantPersonalisationItem,
    AssistantPersonalisationLineage, AssistantPersonalisationRequest,
    AssistantPersonalisationStatus, ExplicitPreferenceSummary,
    WorkspaceAssistantPersonalisationExplanation, WorkspaceAssistantPersonalisationProjection,
    WorkspaceAssistantPersonalisationSnapshot, WorkspaceAssistantPersonalisationSummary,
};
pub use workspace_assistant_retrieval::{
    AssistantRetrievalDiagnostics, AssistantRetrievalError, AssistantRetrievalGap,
    AssistantRetrievalHistoryEntry, AssistantRetrievalItem, AssistantRetrievalLineage,
    AssistantRetrievalRequest, AssistantRetrievalStatus, WorkspaceAssistantRetrievalExplanation,
    WorkspaceAssistantRetrievalProjection, WorkspaceAssistantRetrievalSnapshot,
...
pub use workspace_cognitive_autonomy::{
    AutomationProposal, AutonomyEvidenceLink, AutonomyOpportunity, AutonomyRecommendation,
    AutonomySafetyAssessment, AutonomyStatus, CognitiveAutonomyHistoryEntry, CognitiveAutonomyMeta,
...
pub use workspace_decision_support::{
    DecisionDependency, DecisionSupportAssessment, DecisionSupportCompleteness,
    DecisionSupportContext, DecisionSupportError, DecisionSupportEvidenceRef, DecisionSupportFrame,
    DecisionSupportGap, DecisionSupportHistoryEntry, DecisionSupportStatus, EvidenceBundle,
    TradeoffSummary, WorkspaceDecisionSupportExplanation, WorkspaceDecisionSupportProjection,
...
pub use workspace_evidence_completeness::{
    CompletenessAssessment, CompletenessDiagnostics, CompletenessGap, CompletenessLineage,
    CompletenessObservation, CompletenessObservationState, CompletenessScope,
    EvidenceCompletenessCompleteness, EvidenceCompletenessError, EvidenceCompletenessEvidenceRef,
    EvidenceCompletenessHistoryEntry, EvidenceCompletenessStatus,
    WorkspaceEvidenceCompletenessExplanation, WorkspaceEvidenceCompletenessProjection,
    WorkspaceEvidenceCompletenessSnapshot, WorkspaceEvidenceCompletenessSummary,
};
...
pub use workspace_evidence_coverage::{
    ...
    EvidenceCoverageEvidenceRef, EvidenceCoverageHistoryEntry, EvidenceCoverageStatus,
    WorkspaceEvidenceCoverageExplanation, WorkspaceEvidenceCoverageProjection,
    WorkspaceEvidenceCoverageSnapshot, WorkspaceEvidenceCoverageSummary,
};
pub use workspace_evidence_dependency::{
    ...
    EvidenceDependencyError, EvidenceDependencyEvidenceRef, EvidenceDependencyHistoryEntry,
    EvidenceDependencyStatus, WorkspaceEvidenceDependencyExplanation,
    WorkspaceEvidenceDependencyProjection, WorkspaceEvidenceDependencySnapshot,
    WorkspaceEvidenceDependencySummary,
};
pub use workspace_evidence_freshness::{
    EvidenceFreshnessCompleteness, EvidenceFreshnessError, EvidenceFreshnessEvidenceRef,
    EvidenceFreshnessHistoryEntry, EvidenceFreshnessStatus, FreshnessAssessment,
    FreshnessDiagnostics, FreshnessGap, FreshnessLineage, FreshnessObservation,
    FreshnessObservationState, FreshnessScope, WorkspaceEvidenceFreshnessExplanation,
    WorkspaceEvidenceFreshnessProjection, WorkspaceEvidenceFreshnessSnapshot,
    WorkspaceEvidenceFreshnessSummary,
};
pub use workspace_evidence_navigation::{
    EvidenceNavigationCompleteness, EvidenceNavigationDiagSummary, EvidenceNavigationError,
    EvidenceNavigationEvidenceRef, EvidenceNavigationHistoryEntry, EvidenceNavigationSession,
    EvidenceNavigationStatus, EvidencePath, NavigationGap, NavigationLineage, TraversalScope,
...
pub use workspace_evidence_reliability::{
    EvidenceReliabilityCompleteness, EvidenceReliabilityError, EvidenceReliabilityEvidenceRef,
    EvidenceReliabilityHistoryEntry, EvidenceReliabilityStatus, ReliabilityAssessment,
    ReliabilityDiagnostics, ReliabilityGap, ReliabilityLineage, ReliabilityObservation,
...
pub use workspace_insight_coordination::{
    CoordinationAssessment, InsightAttentionSignal, InsightCluster,
    InsightCoordinationCompleteness, InsightCoordinationError, InsightCoordinationExplanation,
    InsightCoordinationFrame, InsightCoordinationHistoryEntry, InsightCoordinationProjection,
    InsightCoordinationSnapshot, InsightCoordinationStatus, InsightCoordinationSummary,
    InsightEvidenceRef, InsightGap, InsightIntersection,
};
pub use workspace_intelligence_hub::{
    ...
    IntelligenceHubError, IntelligenceHubEvidenceRef, IntelligenceHubFrame,
    IntelligenceHubHistoryEntry, IntelligenceHubStatus, IntelligenceLineage, IntelligencePackage,
    IntelligenceSummary, WorkspaceIntelligenceHubExplanation, WorkspaceIntelligenceHubProjection,
...
pub use workspace_observation::{
    ...
    ObservationFreshness, ObservationFreshnessEnsureResult, ObservationFreshnessRequirement,
...
pub use workspace_readiness::{
    ...
    ReadinessSummary, WorkspaceReadinessError, WorkspaceReadinessState, WorkspaceReadinessSummary,
};
...
pub use workspace_recommendation::{
    ...
    RecommendationHistoryEntry, RecommendationItem, RecommendationKind, RecommendationOutcomeView,
...
pub use workspace_semantic_query::{
    RetrievalDiagnostics, RetrievalGap, RetrievalLineage, SemanticMatch, SemanticQuery,
    SemanticQueryCompleteness, SemanticQueryError, SemanticQueryEvidenceRef,
    SemanticQueryHistoryEntry, SemanticQueryResult, SemanticQueryScope, SemanticQueryStatus,
    SemanticRelevance, WorkspaceSemanticQueryExplanation, WorkspaceSemanticQueryProjection,
    WorkspaceSemanticQuerySnapshot, WorkspaceSemanticQuerySummary,
};
...
pub use recovery_contract::{
    ...
    recovery_must_not_fabricate_actionable_assistant_personalisation_history,
    ...
    recovery_must_not_fabricate_actionable_graph_history,
    ...
    recovery_must_not_fabricate_assistant_personalisation,
    ...
    recovery_must_not_fabricate_evidence_coverage, recovery_must_not_fabricate_evidence_dependency,
    recovery_must_not_fabricate_evidence_freshness,
    recovery_must_not_fabricate_evidence_navigation,
    recovery_must_not_fabricate_evidence_reliability, recovery_must_not_fabricate_evidence_trace,
    recovery_must_not_fabricate_historical_reconstruction,
    recovery_must_not_fabricate_insight_coordination, recovery_must_not_fabricate_intelligence_hub,
    recovery_must_not_fabricate_knowledge_integration,
    recovery_must_not_fabricate_knowledge_synthesis, recovery_must_not_fabricate_learning,
    recovery_must_not_fabricate_orchestration, recovery_must_not_fabricate_policy_governance,
    recovery_must_not_fabricate_reasoning, recovery_must_not_fabricate_semantic_query,
    recovery_must_not_fabricate_temporal_intelligence,
    recovery_must_not_fabricate_workspace_explanation,
    recovery_must_not_fabricate_workspace_state_envelope, recovery_must_not_invent_completed,
...
pub use workspace_runtime::{
    ...
    RuntimeDiagnosticArchiveKind, RuntimeDiagnosticCatalogIntegrity, RuntimeDiagnosticComparison,
    RuntimeDiagnosticCompatibilityContract, RuntimeDiagnosticCompatibilityReport,
    RuntimeDiagnosticConfidence, RuntimeDiagnosticConsumerKind,
    RuntimeDiagnosticConsumptionContract, RuntimeDiagnosticConsumptionMode,
    RuntimeDiagnosticContinuityRecord, RuntimeDiagnosticContractCatalog,
    RuntimeDiagnosticContractCatalogEntry, RuntimeDiagnosticContractDependency,
    RuntimeDiagnosticContractFamily, RuntimeDiagnosticContractIdentity, RuntimeDiagnosticCurrency,
    RuntimeDiagnosticDelta, RuntimeDiagnosticDeltaKind, RuntimeDiagnosticEvidenceBundle,
    RuntimeDiagnosticEvidenceKind, RuntimeDiagnosticEvidenceRef, RuntimeDiagnosticEvolutionReport,
    RuntimeDiagnosticExplanationConsistency, RuntimeDiagnosticExplanationIntegrity,
    RuntimeDiagnosticFinding, RuntimeDiagnosticFindingScope,
    RuntimeDiagnosticForbiddenInterpretation, RuntimeDiagnosticHistoricalIntegrity,
    RuntimeDiagnosticInteropContract, RuntimeDiagnosticInteropDomain,
    RuntimeDiagnosticInteropEntry, RuntimeDiagnosticInterpretationView,
    RuntimeDiagnosticLifecycleClosure, RuntimeDiagnosticLifecyclePhase,
    RuntimeDiagnosticLifecycleRecord, RuntimeDiagnosticLineageRecord, RuntimeDiagnosticLineageStep,
    RuntimeDiagnosticLineageValidation, RuntimeDiagnosticMaturityAssessment,
    RuntimeDiagnosticMaturityLevel, RuntimeDiagnosticModuleLayering,
    RuntimeDiagnosticOwnershipBoundary, RuntimeDiagnosticOwnershipRole,
    RuntimeDiagnosticProvenance, RuntimeDiagnosticReferenceIntegrity,
    RuntimeDiagnosticRestorationView, RuntimeDiagnosticRetentionPolicy, RuntimeDiagnosticSnapshot,
    RuntimeDiagnosticSourceKind, RuntimeDiagnosticSourceRef, RuntimeDiagnosticSubsystemBoundary,
    RuntimeDiagnosticTrustRecord, RuntimeGovernanceIntegrationPoint,
...
pub use workspace_task_graph::{
    would_create_cycle, TaskDependency, TaskGraph, TaskGraphError, TaskGraphSummary,
    TaskHistoryEntry, TaskMetadata, TaskNode, TaskRelationship, TaskRelationshipKind,
