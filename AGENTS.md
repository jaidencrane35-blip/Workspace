...
- **Product contract:** `docs/01-Product/WORKSPACE-DESKTOP-INTERACTION-MODEL.md` (binding user experience / hierarchy / feel).
- **UI vs contract audit:** `docs/01-Product/WORKSPACE-INTERACTION-MODEL-AUDIT.md` (scores + recommended IM slices; do not implement from audit alone).
