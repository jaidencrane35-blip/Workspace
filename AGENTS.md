...
Current handoff posture (see handoff + health for truth): **P16.34 Desktop Cognition — engineering complete for this program; Product Proof pending Owner acceptance. Owner evidence outranks engineering confidence. Canonical: docs/capability-runtime/product-proof/VOICE_P16_34_DESKTOP_COGNITION.md. Do not begin P17. Do not mark P16 permanently closed.**
