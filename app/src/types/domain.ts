...
export interface ExplanationPackage {
  ...
  completeness: string;
  provenance_links: EvidenceReference[];
  narrative: string;
  limitations: string[];
  authority_effect: string;
  actionable: boolean;
...
export interface WorkspaceExplanationHistoryEntry {
  explanation_id: string;
  status: string;
  created_at: string;
  superseded_at: string | null;
...
export interface WorkspaceExplanationSnapshot {
  workspace_id: string;
  generated_at: string;
  current: ExplanationPackage | null;
  history: WorkspaceExplanationHistoryEntry[];
  history_count: number;
  authority_effect: string;
}

export interface WorkspaceExplanationSummary {
  workspace_id: string;
  generated_at: string;
  has_current: boolean;
...
export interface WorkspaceSituationExplanation {
  explanation_id: string;
  workspace_id: string;
  completeness: string | null;
...
export interface EvidenceCompletenessEvidenceRef {
  external_ref: string;
  origin_domain: string;
  source_revision: string | null;
  authority_effect: string;
...
export interface CompletenessAssessment {
  ...
  observed_scope: string[];
  participating_artefacts: string[];
  observable_completeness_state: string[];
  authority_effect: string;
  actionable: boolean;
}
...
export interface CompletenessObservation {
  ...
  state: string;
  description: string;
  evidence_refs: EvidenceCompletenessEvidenceRef[];
  authority_effect: string;
  actionable: boolean;
}
...
export interface CompletenessLineage {
  lineage_id: string;
  contributing_artefacts: string[];
  revisions: string[];
  evidence_refs: EvidenceCompletenessEvidenceRef[];
...
export interface CompletenessDiagnostics {
  diagnostics_id: string;
  observed_completeness_coverage: string;
...
export interface WorkspaceEvidenceCompletenessSnapshot {
  ...
  lineage: CompletenessLineage;
  diagnostics: CompletenessDiagnostics;
  completeness: string;
  provenance_links: EvidenceCompletenessEvidenceRef[];
  source_revisions: string[];
  narrative_summary: string;
  narrative: string;
  limitations: string[];
...
export interface EvidenceCompletenessHistoryEntry {
  completeness_id: string;
  status: string;
  created_at: string;
  superseded_at: string | null;
...
export interface WorkspaceEvidenceCompletenessProjection {
  workspace_id: string;
  current: WorkspaceEvidenceCompletenessSnapshot | null;
  history: EvidenceCompletenessHistoryEntry[];
  history_count: number;
  projected_at: string;
  authority_effect: string;
}

export interface WorkspaceEvidenceCompletenessSummary {
  workspace_id: string;
  has_current: boolean;
  completeness: string | null;
  observation_count: number;
...
export interface WorkspaceEvidenceCompletenessExplanation {
  explanation_id: string;
  workspace_id: string;
  completeness: string | null;
  narrative_summary: string | null;
...
export interface AssistantRetrievalRequest {
  request_id: string;
  human_ask: string;
  scope: AssistantSurfaceScope;
...
export interface AssistantRetrievalLineage {
  lineage_id: string;
  contributing_artefacts: string[];
  revisions: string[];
  source_refs: string[];
...
export interface AssistantRetrievalGap {
  gap_id: string;
  gap_kind: string;
  description: string;
...
export interface AssistantRetrievalDiagnostics {
  ...
  scoped_out_pathways: string[];
  notes: string[];
  authority_effect: string;
  actionable: boolean;
}

export interface WorkspaceAssistantRetrievalSnapshot {
  retrieval_id: string;
  workspace_id: string;
  generated_at: string;
  status: string;
  superseded_at: string | null;
  request: AssistantRetrievalRequest;
  items: AssistantRetrievalItem[];
  lineage: AssistantRetrievalLineage;
  gaps: AssistantRetrievalGap[];
  diagnostics: AssistantRetrievalDiagnostics;
  narrative_summary: string;
  narrative: string;
  limitations: string[];
  authority_effect: string;
...
export interface AssistantRetrievalHistoryEntry {
  retrieval_id: string;
  status: string;
  created_at: string;
  superseded_at: string | null;
...
export interface WorkspaceAssistantRetrievalProjection {
  workspace_id: string;
  current: WorkspaceAssistantRetrievalSnapshot | null;
  history: AssistantRetrievalHistoryEntry[];
  history_count: number;
  projected_at: string;
  authority_effect: string;
}

export interface WorkspaceAssistantRetrievalSummary {
  workspace_id: string;
  has_current: boolean;
  item_count: number;
  gap_count: number;
...
export interface WorkspaceAssistantRetrievalExplanation {
  explanation_id: string;
  workspace_id: string;
  narrative_summary: string | null;
  item_summaries: string[];
