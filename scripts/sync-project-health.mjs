...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "P16 Engineering Complete (incl. P16.10 stability: spawn_blocking, warm-only mic probe, Owner Directed Product Proof). Product Complete is Owner-only. Do not mark permanently closed. Do not begin P17.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "P16 Voice Input Engineering Complete (incl. P16.10 stabilization) — Product Proof pending Owner acceptance (NOT permanently closed)",
  ...
  currentMilestone: {
    id: "engineering-stabilization-p16-10",
    title: "P16.10 Product Completion & Engineering Stabilization",
    status: "engineering_complete_product_proof_pending",
  ...
  outstandingProductDebt: [
    {
      ...
      track: "B",
      summary:
        "P16 Voice Input — live Product Owner Product Proof pending final acceptance (Engineering Complete incl. P16.10 stabilization; not permanently closed)",
    },
    {
  ...
  repositoryHealth: {
    ...
    notes: [
      ...
      "P15 Screenshot Provider permanently closed",
      "P16 Voice Input Engineering Complete (P16.10 stabilization) — Product Proof pending Owner acceptance",
  ...
  lastMilestone: {
    ...
    title:
      "P16.10 Engineering Stabilization — awaiting Owner acceptance",
