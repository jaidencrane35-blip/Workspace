...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "P16 Engineering Complete (incl. P16.17 Production Readiness Audit). Product Complete is Owner-only. After Owner closes Workspace: cleanup only, never relaunch. Do not mark permanently closed. Do not begin P17.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "P16 Voice Input Engineering Complete (incl. P16.17 Production Readiness Audit) — Product Proof pending Owner acceptance (NOT permanently closed)",
  ...
  currentMilestone: {
    id: "voice-production-readiness-p16-17",
    title: "P16.17 Production Readiness Audit & Final Product Completion",
    status: "engineering_complete_product_proof_pending",
  ...
  outstandingProductDebt: [
    {
      ...
      track: "B",
      summary:
        "P16 Voice Input — live Product Owner Product Proof pending final acceptance (Engineering Complete incl. P16.17 Production Readiness Audit; not permanently closed)",
    },
    {
  ...
  repositoryHealth: {
    ...
    notes: [
      ...
      "P15 Screenshot Provider permanently closed",
      "P16 Voice Input Engineering Complete (P16.17 Production Readiness Audit) — Product Proof pending Owner acceptance",
  ...
  lastMilestone: {
    ...
    title:
      "P16.17 Voice Production Readiness Audit — awaiting Owner acceptance",
