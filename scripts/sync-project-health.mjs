...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "P16 Engineering Complete (incl. P16.9 Ready contract, session stitching, Permission Guidance). Live Product Owner Product Proof still pending final acceptance. Do not mark permanently closed. Do not begin P17.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "P16 Voice Input Engineering Complete (incl. P16.9 Product Completion) — Product Proof pending Owner acceptance (NOT permanently closed)",
  ...
  currentMilestone: {
    id: "voice-product-completion-p16-9",
    title: "P16.9 Voice Product Completion Program",
    status: "engineering_complete_product_proof_pending",
  ...
  outstandingProductDebt: [
    {
      ...
      track: "B",
      summary:
        "P16 Voice Input — live Product Owner Product Proof pending final acceptance (Engineering Complete incl. P16.9 Product Completion; not permanently closed)",
    },
    {
  ...
  repositoryHealth: {
    ...
    notes: [
      ...
      "P15 Screenshot Provider permanently closed",
      "P16 Voice Input Engineering Complete (P16.9 Product Completion) — Product Proof pending Owner acceptance",
  ...
  lastMilestone: {
    ...
    title:
      "P16.9 Voice Product Completion — awaiting Owner acceptance",
