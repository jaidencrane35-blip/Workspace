...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "Release Hold (R2) + Capability Atlas v2.0 (Readiness Scores). C-OBS-003/004 eng complete — Owner Product Proof required. Next Atlas eng: C-ACT-004 (+ C-ACT-005). Parallel: A2 after Authenticode cert. File Provider blocked. nextReadyNow D1.",
  },
  ...
  lastMilestone: {
    ...
    title: "P22.S3 Window Control Discovery (C-OBS-004) — Product Proof pending",
    reviewBrief:
  ...
  nextRecommendedExecutionProgram: {
    id: "c-act-004-mouse-click",
    title: "C-ACT-004 Mouse Click (+ C-ACT-005 Keyboard Input)",
    blockedUntil: "Atlas Execution Loop next session (after C-OBS-004 stop)",
    note: "Highest remaining Atlas capability after C-OBS-004 eng. File Provider remains blocked on Voice Accept. Release track: A2 after Authenticode cert.",
  },
  capabilityEvolution: {
