...
const health = {
  ...
  currentExecutionProgram: {
    id: "application-provider-p11",
    title: "P11 Application Provider",
    status: "complete_awaiting_owner_review",
    note: "Application Provider operations (launch/enumerate/focus/close/minimize/restore/find) on frozen Capability Runtime. Providers own operations. Await Owner review before P12.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "Application Provider operations shipped (P11)",
      "Providers own operations — permanent rule",
    ],
  },
  currentMilestone: {
    id: "application-provider-p11",
  ...
  outstandingProductDebt: [
    {
      id: "capability-providers-p12-plus",
      track: "B",
      summary: "Window / Notification / Browser / Screenshot providers await Owner review of P11",
    },
    {
      id: "tray-integration",
      track: "A",
  ...
  repositoryHealth: {
    ...
    notes: [
      ...
      "Capability Runtime Foundation accepted (P10); Application Provider (P11)",
  ...
  lastMilestone: {
    date: "2026-08-07",
    document: "docs/capability-runtime/APPLICATION_PROVIDER.md",
    title: "P11 Application Provider",
    reviewBrief: "docs/capability-runtime/00_INDEX.md",
  },
  handoffStatus: "AWAITING_PROJECT_OWNER_APPLICATION_PROVIDER_REVIEW",
  nextRecommendedExecutionProgram: {
    id: "window-provider-p12",
    title: "P12 Window Provider (reassess after Owner review)",
    blockedUntil: "Project Owner Application Provider review",
  },
  capabilityEvolution: {
