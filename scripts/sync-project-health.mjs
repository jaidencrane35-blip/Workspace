...
const health = {
  ...
  currentExecutionProgram: {
    id: "browser-provider-p14-5-finalization",
    title: "P14.5 Browser Product Proof Finalization & Permanent Closure",
    status: "permanently_closed",
    note: "P14 permanently closed. P12.5 stamped DO NOT REOPEN. Provider Acceptance Standard permanent. P15 eligible.",
  },
  ...
  lastMilestone: {
    ...
    title: "P14.5 Finalization — P14 permanently closed; P12.5 do-not-reopen",
    reviewBrief: "docs/capability-runtime/PROVIDER_ACCEPTANCE_STANDARD.md",
  },
  ...
  nextRecommendedExecutionProgram: {
    ...
    blockedUntil: null,
    note: "P14 permanently closed. Follow Provider Acceptance Standard. Do not begin until Owner starts P15.",
  },
  capabilityEvolution: {
