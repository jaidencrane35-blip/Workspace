...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "P16.PQ1: Product Quality Standard established; calm post-dictation cue. Owner Product Proof still pending. P17 blocked. Production A1 await Owner. No Spec/governance reopen.",
  },
