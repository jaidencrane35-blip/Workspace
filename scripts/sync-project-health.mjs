...
const health = {
  ...
  currentExecutionProgram: {
    id: "browser-provider-p14-5",
    title: "P14.5 Browser Product Proof Remediation",
    status: "permanently_closed",
    note: "P14 Product Complete and permanently closed under Natural Language Robustness Rule. P15 Screenshot is next.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "P14 Browser Provider permanently closed (P14.5 Product Proof + NL Robustness)",
  ...
  acceptedReviews: [
    ...
    },
    {
      ...
      commit: "1670822",
      acceptedAt: "2026-08-07",
      note: "Engineering + Product Proof closed via P14.5",
    },
  ],
  outstandingProductDebt: [
    {
      ...
      track: "B",
      summary: "Screenshot / File / Terminal providers — P15+ (P14 Browser permanently closed)",
    },
    {
      id: "tray-integration",
      track: "A",
  ...
  lastMilestone: {
    ...
    title: "P14.5 Browser Product Proof Remediation — P14 permanently closed",
    reviewBrief: "docs/capability-runtime/product-proof/BROWSER_PROVIDER_PRODUCT_PROOF.md",
  },
  handoffStatus: "P14_PERMANENTLY_CLOSED_P15_ELIGIBLE",
  nextRecommendedExecutionProgram: {
    id: "screenshot-provider-p15",
    title: "P15 Screenshot Provider",
    blockedUntil: null,
    note: "P14 permanently closed. P15 is the next constitutional execution program.",
  },
  capabilityEvolution: {
