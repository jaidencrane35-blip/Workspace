...
const health = {
  ...
  currentExecutionProgram: {
    ...
    note: "P16 Engineering Complete (incl. P16.14 foundation audit + MediaCapture warm-race fix). Product Complete is Owner-only. After Owner closes Workspace: cleanup only, never relaunch. Do not mark permanently closed. Do not begin P17.",
  },
  ...
  productReadiness: {
    ...
    notes: [
      ...
      "P16 Voice Input Engineering Complete (incl. P16.14 foundation audit) — Product Proof pending Owner acceptance (NOT permanently closed)",
  ...
  currentMilestone: {
    id: "voice-foundation-audit-p16-14",
    title: "P16.14 Technology Validation, Voice Foundation Audit & Product Proof Completion",
    status: "engineering_complete_product_proof_pending",
  ...
  outstandingProductDebt: [
    {
      ...
      track: "B",
      summary:
        "P16 Voice Input — live Product Owner Product Proof pending final acceptance (Engineering Complete incl. P16.14 foundation audit; not permanently closed)",
    },
    {
  ...
  repositoryHealth: {
    ...
    notes: [
      ...
      "P15 Screenshot Provider permanently closed",
      "P16 Voice Input Engineering Complete (P16.14 foundation audit) — Product Proof pending Owner acceptance",
  ...
  lastMilestone: {
    ...
    title:
      "P16.14 Voice Foundation Audit — awaiting Owner Product Proof acceptance",
