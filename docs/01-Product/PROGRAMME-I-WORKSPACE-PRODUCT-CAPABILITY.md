...
| Field | Value |
|-------|-------|
| **Status** | Active — disciplined product maturation (IC1–IC5 approved; IC6 planned) |
...
| **IC6** | Planned: operational confidence — explanations of current action, Restore consequences, Arrangement currency (awaiting approval to commence) |
