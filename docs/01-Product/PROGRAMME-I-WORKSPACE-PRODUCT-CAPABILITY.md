...
| **Implementation contracts** | [IC1 — Product Shell Capability Inventory](PROGRAMME-I-IC1-PRODUCT-SHELL-CAPABILITY-INVENTORY.md) (complete); [IC2 — Product Workspace Composition](PROGRAMME-I-IC2-PRODUCT-WORKSPACE-COMPOSITION.md) (complete) |
