...
RecommendationDecisionIntakeProceedDenial
  ...
  proceed_authorized = false (always)
        ...
        ↓ RecommendationDecisionIntakePackageSeal (frozen digest)
        ✗ seal ≠ proceed / adapter / handoff
...
See [WORKSPACE-RECOMMENDATION-DECISION-INTAKE-PACKAGE-SEAL.md](./WORKSPACE-RECOMMENDATION-DECISION-INTAKE-PACKAGE-SEAL.md).
