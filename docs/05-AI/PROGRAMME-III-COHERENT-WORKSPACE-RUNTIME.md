...
| **Status** | Active — Batch 3 charter drafted (pending review) |
...
| **3** | Historical Workspace Reconstruction | Temporal comparison / change explanation | Charter drafted — pending review |
...
## Batch 3 charter (draft)

`WorkspaceHistoricalReconstructionService` will compose temporal views, revision
comparisons, evidence timelines, and change explanations from durable snapshots,
projection history, and observational audit evidence.
...
**Do not begin Batch 3 implementation until the charter is reviewed and approved.**

## Sequencing rule

Ship Batch *N* only when Batch *N−1* has durable contracts, tests, and governance ownership entries.
Batch 3 implementation is gated on charter review approval.
...
- [Historical Workspace Reconstruction Architecture](./HISTORICAL-WORKSPACE-RECONSTRUCTION-ARCHITECTURE.md) (Batch 3 charter)
