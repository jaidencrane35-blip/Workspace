...
| **Latest program** | P16.10 Product Completion & Engineering Stabilization (awaiting Owner) |
...
| Execution protocol | `.cursor/rules/constitutional-execution-protocol.mdc` (**v1.8**) |
