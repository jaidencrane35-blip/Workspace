...
| Product delivery (next) | [Product Delivery Roadmap](01-Product/WORKSPACE-PRODUCT-DELIVERY-ROADMAP.md) · [Milestone D completion](03-Engineering/MILESTONE-D-WORKSPACE-STAGE-COMPLETION-REPORT.md) · [Milestone D review package](03-Engineering/MILESTONE-D-HUMAN-REVIEW-PACKAGE.md) (await review before F) |
...
| [Workspace Product Delivery Roadmap](01-Product/WORKSPACE-PRODUCT-DELIVERY-ROADMAP.md) | Post-foundation milestones D–I (D implemented — await review before F) |
...
| [DAF-1e Arrangement UI](03-Engineering/DAF-1E-DESKTOP-ARRANGEMENT-UI.md) | Human-facing save/select/restore |
| [DAF-1e Alignment Check](03-Engineering/DAF-1E-ALIGNMENT-CHECK.md) | DAF-1e gate record |
