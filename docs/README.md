...
| [Conversational / Assistant Surface Architecture](05-AI/CONVERSATIONAL-ASSISTANT-SURFACE-ARCHITECTURE.md) | Programme IV Batch 11 — charter only (not accepted for implementation) |
